...
iface4 = node_1.addInterface('interface-0', pg.IPv4Address('10.0.0.100','255.255.255.0'))

# Node node-2
node_2 = request.XenVM('juliet')
node_2.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU22-64-STD'
iface5 = node_2.addInterface('interface-2', pg.IPv4Address('10.0.0.101','255.255.255.0'))

# Node node-3
node_3 = request.XenVM('hamlet')
node_3.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU22-64-STD'
iface6 = node_3.addInterface('interface-4', pg.IPv4Address('10.0.0.102','255.255.255.0'))
