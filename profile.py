...
node_petruchio.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
...
node_router_4.addService(pg.Execute('/bin/sh','bash /local/repository/scripts/no-offload.sh'))
