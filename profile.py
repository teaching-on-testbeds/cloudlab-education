...
node_romeo.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU16-64-STD'
...
node_hamlet.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU16-64-STD'
...
node_othello.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU16-64-STD'
...
node_petruchio.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU16-64-STD'
...
node_router_3.addService(pg.Execute('/bin/sh','wget -O - https://git.io/JYhs5 | bash'))
...
node_router_2.addService(pg.Execute('/bin/sh','wget -O - https://git.io/JYhs5 | bash'))
...
node_router_1.addService(pg.Execute('/bin/sh','wget -O - https://git.io/JYhs5 | bash'))
...
node_router_4.disk_image = 'urn:publicid:IDN+emulab.net+image+emulab-ops:UBUNTU16-64-STD'
...
node_router_4.addService(pg.Execute('/bin/sh','wget -O - https://git.io/JYhs5 | bash'))
